...
static const Key keys[] = {
	...
	{ 0,           MODKEY|ShiftMask,             XK_c,      movecenter,     {0} },
	...
	{ 2, MODKEY,                    XK_c,                       spawn,  SHCMD("localc") }, /* LibreOffice Calc */
	{ 1, MODKEY|ShiftMask,          XK_x,                       spawn,  SHCMD("emacsclient -nc || notify-send 'Error' 'Emacs is not running as daemon.'") },
	{ 1, MODKEY|ShiftMask,          XK_f,                       spawn,  SHCMD("firefox") },
    { 2, MODKEY|ShiftMask,          XK_f,                       spawn,  SHCMD("firefox --private-window") },
	{ 3, MODKEY|ShiftMask,          XK_f,                       spawn,  SHCMD("flameshot") },
	{ 1, MODKEY|ShiftMask,          XK_p,                       spawn,  SHCMD("powerprofilesgui") },
	{ 2, MODKEY|ShiftMask,          XK_p,                       spawn,  SHCMD("powerprofilesgui -a") },
	/* I manage to execute it with elogind in: /lib/elogind/system-sleep/pre-suspend.sh */
	/* { 0, 0,                         XF86XK_Sleep,               spawn,  SHCMD("slock") }, */
	{ 1, MODKEY|ShiftMask,          XK_l,                       spawn,  SHCMD("slock") },
	{ 1, MODKEY|ShiftMask,          XK_k,                       spawn,  SHCMD("/home/brayan/.scripts/setxkb.sh") },
    { 1, MODKEY,                    XK_s,                       spawn,  SHCMD("spm") },
	{ 1, MODKEY|ShiftMask,          XK_t,                       spawn,  SHCMD("Telegram") },
	{ 1, MODKEY,                    XK_q,                       spawn,  SHCMD("qtcreator") },
	{ 2, MODKEY,                    XK_q,                       spawn,  SHCMD("qbittorrent") },
